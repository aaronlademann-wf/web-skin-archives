/* ==========================================================
 * wdesk-chosen.js v1.2.0 (http://bit.ly/18CWEdt)
...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        this.container.html('<ul class="chosen-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chosen-drop dropdown-menu"><ul class="chosen-results"></ul></div>');
      } else {
        this.container.html('<a class="chosen-single chosen-default btn dropdown-toggle" tabindex="-1"><span>' + this.default_text + '</span><b class="caret"></b></a><div class="chosen-drop dropdown-menu"><div class="chosen-search"><input type="text" autocomplete="off" class="input-small" /></div><ul class="chosen-results"></ul></div>');
      }
    ...
    Chosen.prototype.results_build = function() {
      ...
      if (this.results_count > 0) {
        this.results_all_chosen = false;
      } else {
        this.results_all_chosen = true;
      }
      if (this.is_multiple) {
    ...
    Chosen.prototype.results_show = function() {
      ...
      if (this.is_multiple && this.results_all_chosen) {
    ...
    Chosen.prototype.choice_build = function(item) {
      var choice, close_link,
        _this = this;
      choice = $('<li />', {
        "class": "search-choice btn btn-small"
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if (this.result_highlight) {
        ...
        if (this.selected_option_count === this.results_count) {
          this.results_all_chosen = true;
        } else {
          this.results_all_chosen = false;
        }
