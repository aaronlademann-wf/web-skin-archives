        ...
        setTimeout(function(){
            ...
            if(isLtIE9) {
                ...
                // ---------------------------------------------------------------------------
                  ...
                  var $searchInputs = $("#icons .input-search");
                  ...
                  //----------------------------------------------
                    ...
                    // MAIN SET
                    var $mainGlyphSet = $(".wdesk-docs-icomoon-glyphs #main");
                    ...
                    // TWO COLOR SET
                    var $twoColorGlyphSet = $(".wdesk-docs-icomoon-glyphs #two-color");
                    // don't parse this entire list unless its there :)
                    if($twoColorGlyphSet.length > 0) {
                      for (var twoColorClassname in twoColorPua) {
                        iconExampleDOMupdate(twoColorClassname, twoColorPua, $twoColorGlyphSet, true);
                      }
                    }

                    // SEC DOCTYPE SET
                    var $secGlyphSet = $(".wdesk-docs-icomoon-glyphs #sec");
                    // don't parse this entire list unless its there :)
